...
INSERT INTO locations (name, building, campus, description) VALUES
                                                                ...
                                                                ('Laboratorio de Redes', 'Edificio K', 'Loma Bonita', 'Prácticas de enrutamiento y conmutación'),
                                                                ('Laboratorio de Enfermería', 'Edificio Salud', 'Tuxtepec', 'Área de simuladores médicos'),
                                                                ('Biblioteca Central', 'Edificio B', 'Loma Bonita', 'Área de lectura y acervo'),
                                                                ('Aula Múltiple 1', 'Edificio A', 'Loma Bonita', 'Aulas de tronco común'),
                                                                ('Aula Múltiple 2', 'Edificio A', 'Loma Bonita', 'Aulas de tronco común'),
                                                                ...
                                                                ('Cafetería Universitaria', 'Servicios', 'Loma Bonita', 'Comedor de estudiantes'),
                                                                ('Taller Mecánico', 'Nave Industrial', 'Loma Bonita', 'Sistemas Automotrices'),
                                                                ('Cancha de Usos Múltiples', 'Deportivo', 'Loma Bonita', 'Área deportiva'),
                                                                ('Invernadero 1', 'Campo Agrícola', 'Loma Bonita', 'Prácticas de agronomía'),
                                                                ('Invernadero 2', 'Campo Agrícola', 'Loma Bonita', 'Prácticas de agronomía'),
                                                                ('Corrales de Manejo', 'Zootecnia', 'Loma Bonita', 'Manejo de ganado'),
                                                                ('Caseta de Vigilancia Principal', 'Entrada', 'Loma Bonita', 'Control de acceso'),
                                                                ...
                                                                ('Clínica Veterinaria', 'Zootecnia', 'Loma Bonita', 'Atención de pequeñas especies'),
                                                                ('Sala de Titulación', 'Edificio Administrativo', 'Loma Bonita', 'Exámenes profesionales'),
                                                                ('Archivo General', 'Sótano', 'Loma Bonita', 'Resguardo de documentos físicos'),
